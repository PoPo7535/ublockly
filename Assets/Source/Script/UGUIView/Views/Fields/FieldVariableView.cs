...
namespace UBlockly.UGUI
{
    ...
    public class FieldVariableView : FieldView
    {
        ...
        protected override void RegisterTouchEvent()
        {
            ...
            {
                mMenuGroup.SetActive(false);
                mField.SourceBlock.Workspace.DeleteVariable(m_Label.text, Workspace.MapType.Variable);
            });
        }
        ...
        /// </summary>
        protected void UpdateMenuWidth()
        {
        ...
        protected class MemorySafeVariableObserver : IObserver<VariableUpdateData>
        {
