...
namespace UBlockly.Test
{
	public class WorkspaceTest
	{
		...
		public void TestDeleteVariableInternalTrivial()
		{
			...
			mWorkspace.DeleteVariableInternal(var1,Workspace.MapType.Variable);
...
//			setUpMockMethod(mockControl_, Blockly.utils, 'genUid', null, ['1']);
		...
		public void TestDeleteVariableTrivial()
		{
			...
			mWorkspace.DeleteVariable("name1",Workspace.MapType.Variable);
		...
		{
			var varibale = container.GetVariableById(id,Workspace.MapType.Variable);
