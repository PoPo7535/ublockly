    ...
    ***************************/
    ...
    public class Block : Observable<int>
    {
        ...
        public void Dispose(bool healStack = false)
        {
            ...
            // Remove this block from the workspace's dictionary of top-most blocks.
        ...
        public void SetParent(Block newParent)
        {
            ...
            if (null != ParentBlock)
            {
                // Remove this block from the old parent's child dictionary.
        ...
        /// Includes this block in the dictionary.
