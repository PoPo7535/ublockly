...
namespace UBlockly
{
    ...
    public class Define
    {
        ...
        /// ㅁㄴㅇ 추가 카테고리
        /// </summary>
        public const string OBJECT_CATEGORY_NAME = "OBJECT";

        public const string VARIABLE_GET_BLOCK_TYPE = "variables_get";
        public const string VARIABLE_SET_BLOCK_TYPE = "variables_set";
        public const string OBJECT_GET_BLOCK_TYPE = "object_get";
        public const string OBJECT_SET_BLOCK_TYPE = "object_set";
        ...
        /// <summary>
        /// a dictionary of field types defined in block
        /// </summary>
        public static string[] FIELD_TYPES = new string[]
        {  
            "field_label", "field_input", "field_angle", "field_checkbox", "field_colour",
            "field_variable", "field_dropdown", "field_image", "field_number", "field_date", "field_object" // ㅁㄴㅇ
        };
         
        /// <summary>
        /// a dictionary of input types defined in block
        /// </summary>
        ...
        public static Dictionary<EDataType, string[]> DataTypeDB = new Dictionary<EDataType, string[]>()
        {
            ...
            {EDataType.List, new[] {"ArrayList", "dictionary"}},
            {EDataType.Object, new[] {"object"}},
