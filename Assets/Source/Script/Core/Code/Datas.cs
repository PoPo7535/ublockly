        ...
        public ArrayList ListValue
        {
            get
            {
                if (this.Type != Define.EDataType.List)
                    throw new Exception("try to GET a dictionary value from a not-dictionary data");
                return mListValue;
            }
            set
            {
                if (this.Type != Define.EDataType.List)
                    throw new Exception("try to SET a dictionary value from a not-dictionary data");
                mListValue = value;
            }
        }
