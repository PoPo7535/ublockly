...
namespace UBlockly
{
    public sealed class FieldVariable : FieldDropdown
    {
        ...
        public override void SetValue(string newValue)
        {
            ...
            if (SourceBlock != null)
            {
                VariableModel variable = SourceBlock.Workspace.GetVariableById(newValue, Workspace.MapType.Variable);
                if (variable != null)
                {
                    text = variable.Name;
                }
                ...
                {
                    variable = SourceBlock.Workspace.GetVariable(newValue, Workspace.MapType.Variable);
                    if (variable != null)
                        value = variable.ID;
                }
            }
        ...
        private FieldDropdownMenu[] DropdownCreate()
        {
            ...
            if (workspace != null)
            {
                ...
                varModels = workspace.GetVariablesOfType("", Workspace.MapType.Variable);
        ...
        public override void OnItemSelected(int itemIndex)
        {
            ...
            if (SourceBlock != null && SourceBlock.Workspace != null)
            {
                ...
                var variable = workspace.GetVariableById(id, Workspace.MapType.Variable);
                if (variable != null)
                {
