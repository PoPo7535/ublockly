...
namespace UBlockly
{
    ...
    public class FieldDropdown : Field
    {
        ...
        /// <summary>
        /// Return a dictionary of the options for this dropdown.
        /// </summary>
        ...
        /// init the dropdown menu options
        /// </summary>
        /// <param name="menu">An array of options for a dropdown dictionary</param>
        ...
        /// init the dropdown menu options
        /// </summary>
        /// <param name="menuGenerator">a function which generates a dropdown option dictionary</param>
        public void SetOptions(Func<FieldDropdownMenu[]> menuGenerator)
        {
            if (menuGenerator == null)
                return;

            Debug.Log("여기 들어오면 이상");
