...
namespace UBlockly
{
    ...
    public class VariableMap : Observable<VariableUpdateData>
    {
        ...
        /// <summary>
        /// 변수 맵의 클래스입니다. 여기에는 변수 유형을 키로, 변수 목록을 값으로 갖는 사전 데이터 구조가 포함됩니다. 변수 사전은 키가 나타내는 유형입니다.
        /// </summary>
        /// <param name="workspace"> The workspace this map belongs to.</param>
        public VariableMap(Workspace workspace)
        {
            // A map from variable type to dictionary of variable names.
        ...
        public VariableModel CreateVariable(string name, string optType = null, string optId = null)
        {
            ...
            // If optType is not a key,create a new dictionary.
            ...
            {
                // Else append the variable to the preexisting dictionary.
        ...
        /// <summary>
        /// Get a dictionary containing all of the variables of a specified type.If type is
        /// null,return dictionary of variables with empty stringtype.
        /// </summary>
        /// <param name="type"> Type of the variables to find.</param>
        /// <returns>a shallow copy of variable dictionary of type</returns>
