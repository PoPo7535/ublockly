...
namespace UBlockly
{
    public class Xml
    {
        ...
        public static XmlNode WorkspaceToDom(Workspace workspace, bool optNoId = false)
        {
            ...
            xml.AppendChild(VariablesToDom(workspace.GetAllVariables(Workspace.MapType.Variable)));
        ...
        {
            List<string> newBlockIds = new List<string>(); // A dictionary of block ids added by this call.
        ...
        /// <summary>
        /// Encode a dictionary of variables as XML.
        /// </summary>
...
//                if  TODO: editable is true (!string.IsNullOrEmpty(field.Name) && field.Editable)
        ...
        /// <summary>
        /// Decode an XML dictionary of variables and add the variables to the worksapce.
        /// </summary>
                    ...
                    case "field":
                    {
                        ...
                        if (field is FieldVariable)
                        {
                            ...
                            var type = string.IsNullOrEmpty(xmlChild.GetAttribute("variableType"))
                                ...
                                : "";
                            var variable = workspace.GetVariable(text,Workspace.MapType.Variable);
                            
                            // ㅁㄴㅇ 
                            var obj = workspace.GetVariable(text, Workspace.MapType.Object);
                            if (null == variable && null == obj)
                            {
