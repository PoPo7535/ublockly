...
namespace UBlockly
{
    ...
    public class ProcedureDB : Observable<ProcedureUpdateData>
    {
        ...
        /// <summary>
        /// If the block is a procedure block, returns the argument dictionary. Otherwise, it returns null.
        /// </summary>
        ...
        /// <summary>
        /// Adds a block containing a procedure definition to the managed dictionary.  If a procedure
        ...
        /// </summary>
        /// <returns>A dictionary of Blocks that call the procedure defined by block.</returns>
        ...
        /// <param name="argIndexUpdates">A dictionary of mappings from original argument index to new index.</param>
