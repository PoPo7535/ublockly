...
namespace UBlockly
{
    public sealed class FieldObject : FieldDropdown
    {
        [FieldCreator(FieldType = "field_object")]
        private static FieldObject CreateFromJson(JObject json)
        {
            ...
            return new FieldObject(fieldName, varName);
        }
        ...
        public FieldObject(string fieldName, string varName) : base(fieldName)
        {
        ...
        public override void SetValue(string newValue)
        {
            ...
            if (SourceBlock != null)
            {
                VariableModel variable = SourceBlock.Workspace.GetVariableById(newValue, Workspace.MapType.Object);
                if (variable != null)
                {
                    text = variable.Name;
                }
                ...
                {
                    variable = SourceBlock.Workspace.GetVariable(newValue, Workspace.MapType.Object);
                    if (variable != null)
                        value = variable.ID;
                }
            }
        ...
        /// Return a sorted dictionary of variable names for variable dropdown menus.
        ...
        private FieldDropdownMenu[] DropdownCreate()
        {
            ...
            if (workspace != null)
            {
                // Get a copy of the dictionary, so that adding rename and new variable options
                // doesn't modify the workspace's dictionary.
                varModels = workspace.GetVariablesOfType("", Workspace.MapType.Object);
        ...
        public override void OnItemSelected(int itemIndex)
        {
            ...
            if (SourceBlock != null && SourceBlock.Workspace != null)
            {
                ...
                var variable = workspace.GetVariableById(id, Workspace.MapType.Object);
                if (variable != null)
                {
